...
function Team(props) {
  return (
    <div>
      ...
      <br />
      <div>
        <h2 className={styles.title}>Developers Team</h2>
        <div className={styles.wrapper}>
          <div className={styles.wrapper__col}>
            <span className="image fit">
              <img className={styles.wrapper__img} src={Andrey} alt="" />
              <h4 className={styles.wrapper__name}>Andrey Kuznetsov</h4>
          ...
          <div className={styles.wrapper__col}>
            <span className="image fit">
              ...
              <h4 className={styles.wrapper__name}>Anton Ryskin</h4>
              <div className={styles.wrapper__linkCont}>
                <a
                  className={styles.wrapper__link}
          ...
          <div className={styles.wrapper__col}>
            <span className="image fit">
              ...
              <h4 className={styles.wrapper__name}>Asya Amosova</h4>
              <div className={styles.wrapper__linkCont}>
                <a
                  className={styles.wrapper__link}
          ...
          <div className={styles.wrapper__col}>
            <span className="image fit">
              ...
              <h4 className={styles.wrapper__name}>Alexander Polonsky</h4>
              <div className={styles.wrapper__linkCont}>
                <a
                  className={styles.wrapper__link}
